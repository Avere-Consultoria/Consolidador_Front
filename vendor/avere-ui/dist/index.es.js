...
}, ge = e.forwardRef(({ className: e, size: t = "md", ...n }, r) => /* @__PURE__ */ p(B, {
	ref: r,
...
var ct = e.forwardRef((t, n) => {
	let { __scopeRovingFocusGroup: r, orientation: i, loop: a = !1, dir: o, currentTabStopId: s, defaultCurrentTabStopId: c, onCurrentTabStopIdChange: l, onEntryFocus: u, preventScrollOnEntryFocus: d = !1, ...f } = t, m = e.useRef(null), h = H(n, m), g = Xe(o), [_, v] = Ke({
		prop: s,
		defaultProp: c ?? null,
		onChange: l,
		caller: $e
...
var xt = (t) => {
	let { present: n, children: r } = t, i = St(n), a = typeof r == "function" ? r({ present: i.isPresent }) : e.Children.only(r), o = H(i.ref, wt(a));
...
var Nt = "RadioBubbleInput", Pt = e.forwardRef(({ __scopeRadio: t, control: n, checked: r, bubbles: i = !0, ...a }, o) => {
	let s = e.useRef(null), c = H(s, o), l = yt(r), u = vt(n);
	return e.useEffect(() => {
		let e = s.current;
		if (!e) return;
...
var Gt = "RadioGroupItem", Kt = e.forwardRef((t, n) => {
	let { __scopeRadioGroup: r, disabled: i, ...a } = t, o = Ut(Gt, r), s = o.disabled || i, c = Bt(r), l = Vt(r), u = e.useRef(null), d = H(n, u), f = o.value === a.value, m = e.useRef(!1);
	return e.useEffect(() => {
		let e = (e) => {
...
var [hn, gn] = un(on, {
	...
	let { min: r, max: i, dir: a, inverted: o, onSlideStart: s, onSlideMove: c, onSlideEnd: l, onStepKeyDown: u, ...d } = t, [f, m] = e.useState(null), h = H(n, (e) => m(e)), g = e.useRef(void 0), _ = Xe(a), v = _ === "ltr", y = v && !o || !v && o;
	function b(e) {
...
var Sn = "SliderRange", Cn = e.forwardRef((t, n) => {
	let { __scopeSlider: r, ...i } = t, a = pn(Sn, r), o = gn(Sn, r), s = H(n, e.useRef(null)), c = a.values.length, l = a.values.map((e) => An(e, a.min, a.max)), u = c > 1 ? Math.min(...l) : 0, d = 100 - Math.max(...l);
	return /* @__PURE__ */ p(U.span, {
...
var wn = "SliderThumb", Tn = e.forwardRef((t, n) => {
	let r = cn(t.__scopeSlider), [i, a] = e.useState(null), o = H(n, (e) => a(e)), s = e.useMemo(() => i ? r().findIndex((e) => e.ref.current === i) : -1, [r, i]);
	...
	let { __scopeSlider: r, index: i, name: a, ...o } = t, s = pn(wn, r), c = gn(wn, r), [l, u] = e.useState(null), d = H(n, (e) => u(e)), f = l ? s.form || !!l.closest("form") : !0, h = vt(l), g = s.values[i], _ = g === void 0 ? 0 : An(g, s.min, s.max), v = jn(i, s.values.length), y = h?.[c.size], b = y ? Nn(y, _, c.direction) : 0;
	return e.useEffect(() => {
...
var Dn = "RadioBubbleInput", On = e.forwardRef(({ __scopeSlider: t, value: n, ...r }, i) => {
	let a = e.useRef(null), o = H(a, i), s = yt(n);
	return e.useEffect(() => {
		let e = a.current;
		if (!e) return;
...
var Gn = "Switch", [Kn, qn] = ke(Gn), [Jn, Yn] = Kn(Gn), Xn = e.forwardRef((t, n) => {
	let { __scopeSwitch: r, name: i, checked: a, defaultChecked: o, required: s, disabled: c, value: l = "on", onCheckedChange: u, form: d, ...f } = t, [h, g] = e.useState(null), _ = H(n, (e) => g(e)), v = e.useRef(!1), y = h ? d || !!h.closest("form") : !0, [b, x] = Ke({
		prop: a,
		defaultProp: o ?? !1,
		onChange: u,
		caller: Gn
...
var lr = "DismissableLayer", ur = "dismissableLayer.update", dr = "dismissableLayer.pointerDownOutside", fr = "dismissableLayer.focusOutside", pr, mr = e.createContext({
	layers: /* @__PURE__ */ new Set(),
	layersWithOutsidePointerEventsDisabled: /* @__PURE__ */ new Set(),
	branches: /* @__PURE__ */ new Set()
}), hr = e.forwardRef((t, n) => {
	let { disableOutsidePointerEvents: r = !1, onEscapeKeyDown: i, onPointerDownOutside: a, onFocusOutside: o, onInteractOutside: s, onDismiss: c, ...l } = t, u = e.useContext(mr), [d, f] = e.useState(null), m = d?.ownerDocument ?? globalThis?.document, [, h] = e.useState({}), g = H(n, (e) => f(e)), _ = Array.from(u.layers), [v] = [...u.layersWithOutsidePointerEventsDisabled].slice(-1), y = _.indexOf(v), b = d ? _.indexOf(d) : -1, x = u.layersWithOutsidePointerEventsDisabled.size > 0, S = b >= y, C = vr((e) => {
	...
	return cr((e) => {
		...
		if (d) return r && (u.layersWithOutsidePointerEventsDisabled.size === 0 && (pr = m.body.style.pointerEvents, m.body.style.pointerEvents = "none"), u.layersWithOutsidePointerEventsDisabled.add(d)), u.layers.add(d), br(), () => {
		...
		d && (u.layers.delete(d), u.layersWithOutsidePointerEventsDisabled.delete(d), br());
	}, [d, u]), e.useEffect(() => {
		let e = () => h({});
...
hr.displayName = lr;
var gr = "DismissableLayerBranch", _r = e.forwardRef((t, n) => {
	let r = e.useContext(mr), i = e.useRef(null), a = H(n, i);
	return e.useEffect(() => {
		let e = i.current;
...
_r.displayName = gr;
function vr(t, n = globalThis?.document) {
	let r = We(t), i = e.useRef(!1), a = e.useRef(() => {});
	return e.useEffect(() => {
		let e = (e) => {
			if (e.target && !i.current) {
				let t = function() {
					xr(dr, r, i, { discrete: !0 });
				}, i = { originalEvent: e };
...
function yr(t, n = globalThis?.document) {
	...
	return e.useEffect(() => {
		let e = (e) => {
			e.target && !i.current && xr(fr, r, { originalEvent: e }, { discrete: !1 });
		};
...
function Cr() {
	e.useEffect(() => {
		...
		return document.body.insertAdjacentElement("afterbegin", e[0] ?? wr()), document.body.insertAdjacentElement("beforeend", e[1] ?? wr()), Sr++, () => {
			Sr === 1 && document.querySelectorAll("[data-radix-focus-guard]").forEach((e) => e.remove()), Sr--;
		};
	}, []);
}
function wr() {
...
var Tr = "focusScope.autoFocusOnMount", Er = "focusScope.autoFocusOnUnmount", Dr = {
	bubbles: !1,
	cancelable: !0
}, Or = "FocusScope", kr = e.forwardRef((t, n) => {
	let { loop: r = !1, trapped: i = !1, onMountAutoFocus: a, onUnmountAutoFocus: o, ...s } = t, [c, l] = e.useState(null), u = We(a), d = We(o), f = e.useRef(null), m = H(n, (e) => l(e)), h = e.useRef({
		paused: !1,
		pause() {
			this.paused = !0;
		},
	...
	e.useEffect(() => {
		if (i) {
			let e = function(e) {
				...
				let t = e.target;
				c.contains(t) ? f.current = t : Ir(f.current, { select: !0 });
			}, t = function(e) {
				if (h.paused || !c) return;
				let t = e.relatedTarget;
				t !== null && (c.contains(t) || Ir(f.current, { select: !0 }));
			}, n = function(e) {
		...
		if (c) {
			...
			if (!c.contains(e)) {
				...
				c.addEventListener(Tr, u), c.dispatchEvent(t), t.defaultPrevented || (Ar(Br(Mr(c)), { select: !0 }), document.activeElement === e && Ir(c));
			}
			return () => {
				c.removeEventListener(Tr, u), setTimeout(() => {
					let t = new CustomEvent(Er, Dr);
					c.addEventListener(Er, d), c.dispatchEvent(t), t.defaultPrevented || Ir(e ?? document.body, { select: !0 }), c.removeEventListener(Er, d), Lr.remove(h);
				}, 0);
			};
		}
	}, [
	...
	let g = e.useCallback((e) => {
		...
		if (t && n) {
			...
			i && a ? !e.shiftKey && n === a ? (e.preventDefault(), r && Ir(i, { select: !0 })) : e.shiftKey && n === i && (e.preventDefault(), r && Ir(a, { select: !0 })) : n === t && e.preventDefault();
		}
	}, [
		r,
		i,
...
function Nr(e, t) {
	for (let n of e) if (!Pr(n, { upTo: t })) return n;
}
...
var Vr = [
	...
	"bottom",
	"left"
], Hr = Math.min, Ur = Math.max, Wr = Math.round, Gr = Math.floor, Kr = (e) => ({
	x: e,
	y: e
}), qr = {
	left: "right",
...
function ni(e, t, n) {
	n === void 0 && (n = !1);
	let r = Zr(e), i = ti(e), a = $r(i), o = i === "x" ? r === (n ? "end" : "start") ? "right" : "left" : r === "start" ? "bottom" : "top";
	return t.reference[a] > t.floating[a] && (o = di(o)), [o, di(o)];
}
function ri(e) {
	let t = di(e);
	return [
...
var ai = ["left", "right"], oi = ["right", "left"], si = ["top", "bottom"], ci = ["bottom", "top"];
function li(e, t, n) {
	switch (e) {
		case "top":
		case "bottom": return n ? t ? oi : ai : t ? ai : oi;
		case "left":
...
function ui(e, t, n, r) {
	let i = Zr(e), a = li(Xr(e), n === "start", r);
...
function hi(e, t, n) {
	let { reference: r, floating: i } = e, a = ei(t), o = ti(t), s = $r(o), c = Xr(t), l = a === "y", u = r.x + r.width / 2 - i.width / 2, d = r.y + r.height / 2 - i.height / 2, f = r[s] / 2 - i[s] / 2, p;
	switch (c) {
		case "top":
			p = {
				x: u,
...
async function gi(e, t) {
	t === void 0 && (t = {});
	let { x: n, y: r, platform: i, rects: a, elements: o, strategy: s } = e, { boundary: c = "clippingAncestors", rootBoundary: l = "viewport", elementContext: u = "floating", altBoundary: d = !1, padding: f = 0 } = Yr(t, e), p = pi(f), m = o[d ? u === "floating" ? "reference" : "floating" : u], h = mi(await i.getClippingRect({
...
var _i = 50, vi = async (e, t, n) => {
	...
	for (let n = 0; n < a.length; n++) {
		...
		u = v ?? u, d = y ?? d, m[g] = {
			...m[g],
			...b
		}, x && p < _i && (p++, typeof x == "object" && (x.placement && (f = x.placement), x.rects && (l = x.rects === !0 ? await o.getElementRects({
			reference: e,
			floating: t,
			strategy: i
		}) : x.rects), {x: u, y: d} = hi(l, f, c)), n = -1);
	}
	return {
		x: u,
		y: d,
	...
	options: e,
	async fn(t) {
		let { x: n, y: r, placement: i, rects: a, platform: o, elements: s, middlewareData: c } = t, { element: l, padding: u = 0 } = Yr(e, t) || {};
		if (l == null) return {};
		let d = pi(u), f = {
			x: n,
			y: r
		}, p = ti(i), m = $r(p), h = await o.getDimensions(l), g = p === "y", _ = g ? "top" : "left", v = g ? "bottom" : "right", y = g ? "clientHeight" : "clientWidth", b = a.reference[m] + a.reference[p] - f[p] - a.floating[m], x = f[p] - a.reference[p], S = await (o.getOffsetParent == null ? void 0 : o.getOffsetParent(l)), C = S ? S[y] : 0;
		(!C || !await (o.isElement == null ? void 0 : o.isElement(S))) && (C = s.floating[y] || a.floating[m]);
		let w = b / 2 - x / 2, T = C / 2 - h[m] / 2 - 1, E = Hr(d[_], T), D = Hr(d[v], T), O = E, k = C - h[m] - D, A = C / 2 - h[m] / 2 + w, j = Jr(O, A, k), M = !c.arrow && Zr(i) != null && A !== j && a.reference[m] / 2 - (A < O ? E : D) - h[m] / 2 < 0, N = M ? A < O ? A - O : A - k : 0;
		return {
			[p]: f[p] + N,
			data: {
				[p]: j,
	...
	return e === void 0 && (e = {}), {
		...
		async fn(t) {
			var n;
			let { placement: r, middlewareData: i, rects: a, initialPlacement: o, platform: s, elements: c } = t, { mainAxis: l = !0, crossAxis: u = !0, fallbackPlacements: d, fallbackStrategy: f = "bestFit", fallbackAxisSideDirection: p = "none", flipAlignment: m = !0, ...h } = Yr(e, t);
			if ((n = i.arrow) != null && n.alignmentOffset) return {};
			let g = Xr(r), _ = ei(o), v = Xr(o) === o, y = await (s.isRTL == null ? void 0 : s.isRTL(c.floating)), b = d || (v || !m ? [di(o)] : ri(o)), x = p !== "none";
			...
			if (T = [...T, {
				...
				if (t && (!(u === "alignment" && _ !== ei(t)) || T.every((e) => ei(e.placement) === _ ? e.overflows[0] > 0 : !0))) return {
					data: {
						index: e,
						overflows: T
					},
...
var Ci = function(e) {
	return e === void 0 && (e = {}), {
		...
		options: e,
		async fn(t) {
			let { rects: n, platform: r } = t, { strategy: i = "referenceHidden", ...a } = Yr(e, t);
			switch (i) {
				case "referenceHidden": {
					let e = xi(await r.detectOverflow(t, {
						...a,
...
async function Ti(e, t) {
	let { placement: n, platform: r, elements: i } = e, a = await (r.isRTL == null ? void 0 : r.isRTL(i.floating)), o = Xr(n), s = Zr(n), c = ei(n) === "y", l = wi.has(o) ? -1 : 1, u = a && c ? -1 : 1, d = Yr(t, e), { mainAxis: f, crossAxis: p, alignmentAxis: m } = typeof d == "number" ? {
		mainAxis: d,
		crossAxis: 0,
		alignmentAxis: null
	} : {
...
var Ei = function(e) {
	return e === void 0 && (e = 0), {
		...
		async fn(t) {
			var n;
			let { x: r, y: i, placement: a, middlewareData: o } = t, s = await Ti(t, e);
	...
	return e === void 0 && (e = {}), {
		...
		async fn(t) {
			let { x: n, y: r, placement: i, platform: a } = t, { mainAxis: o = !0, crossAxis: s = !1, limiter: c = { fn: (e) => {
				...
				x: n,
				y: r
			}, d = await a.detectOverflow(t, l), f = ei(Xr(i)), p = Qr(f), m = u[p], h = u[f];
			if (o) {
	...
	return e === void 0 && (e = {}), {
		options: e,
		fn(t) {
			let { x: n, y: r, placement: i, rects: a, middlewareData: o } = t, { offset: s = 0, mainAxis: c = !0, crossAxis: l = !0 } = Yr(e, t), u = {
				x: n,
				y: r
			}, d = ei(i), f = Qr(d), p = u[f], m = u[d], h = Yr(s, t), g = typeof h == "number" ? {
				mainAxis: h,
				crossAxis: 0
			} : {
				mainAxis: 0,
			...
			if (l) {
				let e = f === "y" ? "width" : "height", t = wi.has(Xr(i)), n = a.reference[d] - a.floating[e] + (t && o.offset?.[d] || 0) + (t ? 0 : g.crossAxis), r = a.reference[d] + a.reference[e] + (t ? 0 : o.offset?.[d] || 0) - (t ? g.crossAxis : 0);
				m < n ? m = n : m > r && (m = r);
			}
			return {
				[f]: p,
	...
	return e === void 0 && (e = {}), {
		...
		async fn(t) {
			var n, r;
			let { placement: i, rects: a, platform: o, elements: s } = t, { apply: c = () => {}, ...l } = Yr(e, t), u = await o.detectOverflow(t, l), d = Xr(i), f = Zr(i), p = ei(i) === "y", { width: m, height: h } = a.floating, g, _;
			d === "top" || d === "bottom" ? (g = d, _ = f === (await (o.isRTL == null ? void 0 : o.isRTL(s.floating)) ? "start" : "end") ? "left" : "right") : (_ = d, g = f === "end" ? "top" : "bottom");
			let v = h - u.top - u.bottom, y = m - u.left - u.right, b = Hr(h - u[g], v), x = Hr(m - u[_], y), S = !t.middlewareData.shift, C = b, w = x;
			if ((n = t.middlewareData.shift) != null && n.enabled.x && (w = y), (r = t.middlewareData.shift) != null && r.enabled.y && (C = v), S && !f) {
				let e = Ur(u.left, 0), t = Ur(u.right, 0), n = Ur(u.top, 0), r = Ur(u.bottom, 0);
				p ? w = m - 2 * (e !== 0 || t !== 0 ? e + t : Ur(u.left, u.right)) : C = h - 2 * (n !== 0 || r !== 0 ? n + r : Ur(u.top, u.bottom));
			}
			await c({
				...t,
				availableWidth: w,
...
function Pi(e) {
	return Ai() ? e instanceof Node || e instanceof Mi(e).Node : !1;
}
function Fi(e) {
	return Ai() ? e instanceof Element || e instanceof Mi(e).Element : !1;
}
function Ii(e) {
	return Ai() ? e instanceof HTMLElement || e instanceof Mi(e).HTMLElement : !1;
}
function Li(e) {
	return !Ai() || typeof ShadowRoot > "u" ? !1 : e instanceof ShadowRoot || e instanceof Mi(e).ShadowRoot;
}
function Ri(e) {
	let { overflow: t, overflowX: n, overflowY: r, display: i } = Yi(e);
...
var Vi = /transform|translate|scale|rotate|perspective|filter/, Hi = /paint|layout|strict|content/, Ui = (e) => !!e && e !== "none", Wi;
function Gi(e) {
	let t = Fi(e) ? Yi(e) : e;
	return Ui(t.transform) || Ui(t.translate) || Ui(t.scale) || Ui(t.rotate) || Ui(t.perspective) || !qi() && (Ui(t.backdropFilter) || Ui(t.filter)) || Vi.test(t.willChange || "") || Hi.test(t.contain || "");
}
function Ki(e) {
	let t = Zi(e);
	for (; Ii(t) && !Ji(t);) {
...
function qi() {
	return Wi ??= typeof CSS < "u" && CSS.supports && CSS.supports("-webkit-backdrop-filter", "none"), Wi;
}
function Ji(e) {
...
function Zi(e) {
	...
	let t = e.assignedSlot || e.parentNode || Li(e) && e.host || Ni(e);
	return Li(t) ? t.host : t;
}
function Qi(e) {
	let t = Zi(e);
	return Ji(t) ? e.ownerDocument ? e.ownerDocument.body : e.body : Ii(t) && Ri(t) ? t : Qi(t);
}
function $i(e, t, n) {
	t === void 0 && (t = []), n === void 0 && (n = !0);
	let r = Qi(e), i = r === e.ownerDocument?.body, a = Mi(r);
	if (i) {
		let e = ea(a);
		return t.concat(a, a.visualViewport || [], Ri(r) ? r : [], e && n ? $i(e) : []);
	} else return t.concat(r, $i(r, [], n));
}
function ea(e) {
...
function ta(e) {
	let t = Yi(e), n = parseFloat(t.width) || 0, r = parseFloat(t.height) || 0, i = Ii(e), a = i ? e.offsetWidth : n, o = i ? e.offsetHeight : r, s = Wr(n) !== a || Wr(r) !== o;
	return s && (n = a, r = o), {
		width: n,
		height: r,
		$: s
...
function ra(e) {
	let t = na(e);
	if (!Ii(t)) return Kr(1);
	let n = t.getBoundingClientRect(), { width: r, height: i, $: a } = ta(t), o = (a ? Wr(n.width) : n.width) / r, s = (a ? Wr(n.height) : n.height) / i;
	return (!o || !Number.isFinite(o)) && (o = 1), (!s || !Number.isFinite(s)) && (s = 1), {
		x: o,
		y: s
	};
}
var ia = /* @__PURE__ */ Kr(0);
function aa(e) {
	let t = Mi(e);
	return !qi() || !t.visualViewport ? ia : {
		x: t.visualViewport.offsetLeft,
		y: t.visualViewport.offsetTop
	};
}
function oa(e, t, n) {
	return t === void 0 && (t = !1), !n || t && n !== Mi(e) ? !1 : t;
}
function sa(e, t, n, r) {
	t === void 0 && (t = !1), n === void 0 && (n = !1);
	let i = e.getBoundingClientRect(), a = na(e), o = Kr(1);
	t && (r ? Fi(r) && (o = ra(r)) : o = ra(e));
	let s = oa(a, n, r) ? aa(a) : Kr(0), c = (i.left + s.x) / o.x, l = (i.top + s.y) / o.y, u = i.width / o.x, d = i.height / o.y;
	if (a) {
		let e = Mi(a), t = r && Fi(r) ? Mi(r) : r, n = e, i = ea(n);
		for (; i && r && t !== n;) {
			let e = ra(i), t = i.getBoundingClientRect(), r = Yi(i), a = t.left + (i.clientLeft + parseFloat(r.paddingLeft)) * e.x, o = t.top + (i.clientTop + parseFloat(r.paddingTop)) * e.y;
			c *= e.x, l *= e.y, u *= e.x, d *= e.y, c += a, l += o, n = Mi(i), i = ea(n);
		}
	}
	return mi({
		width: u,
...
function ca(e, t) {
	let n = Xi(e).scrollLeft;
	return t ? t.left + n : sa(Ni(e)).left + n;
}
function la(e, t) {
...
function ua(e) {
	let { elements: t, rect: n, offsetParent: r, strategy: i } = e, a = i === "fixed", o = Ni(r), s = t ? Bi(t.floating) : !1;
	if (r === o || s && a) return n;
	let c = {
		scrollLeft: 0,
		scrollTop: 0
	}, l = Kr(1), u = Kr(0), d = Ii(r);
	if ((d || !d && !a) && ((ji(r) !== "body" || Ri(o)) && (c = Xi(r)), d)) {
		let e = sa(r);
		l = ra(r), u.x = e.x + r.clientLeft, u.y = e.y + r.clientTop;
	}
	let f = o && !d && !a ? la(o, c) : Kr(0);
	return {
		width: n.width * l.x,
		height: n.height * l.y,
...
function fa(e) {
	let t = Ni(e), n = Xi(e), r = e.ownerDocument.body, i = Ur(t.scrollWidth, t.clientWidth, r.scrollWidth, r.clientWidth), a = Ur(t.scrollHeight, t.clientHeight, r.scrollHeight, r.clientHeight), o = -n.scrollLeft + ca(e), s = -n.scrollTop;
	return Yi(r).direction === "rtl" && (o += Ur(t.clientWidth, r.clientWidth) - i), {
		width: i,
		height: a,
		x: o,
		y: s
...
var pa = 25;
function ma(e, t) {
	let n = Mi(e), r = Ni(e), i = n.visualViewport, a = r.clientWidth, o = r.clientHeight, s = 0, c = 0;
	if (i) {
...
function ha(e, t) {
	let n = sa(e, !0, t === "fixed"), r = n.top + e.clientTop, i = n.left + e.clientLeft, a = Ii(e) ? ra(e) : Kr(1);
	return {
...
function ga(e, t, n) {
	let r;
	if (t === "viewport") r = ma(e, n);
	else if (t === "document") r = fa(Ni(e));
	else if (Fi(t)) r = ha(t, n);
	else {
		let n = aa(e);
		r = {
			x: t.x - n.x,
...
function _a(e, t) {
	let n = Zi(e);
	return n === t || !Fi(n) || Ji(n) ? !1 : Yi(n).position === "fixed" || _a(n, t);
}
function va(e, t) {
	let n = t.get(e);
	if (n) return n;
	let r = $i(e, [], !1).filter((e) => Fi(e) && ji(e) !== "body"), i = null, a = Yi(e).position === "fixed", o = a ? Zi(e) : e;
	for (; Fi(o) && !Ji(o);) {
		let t = Yi(o), n = Gi(o);
		!n && t.position === "fixed" && (i = null), (a ? !n && !i : !n && t.position === "static" && i && (i.position === "absolute" || i.position === "fixed") || Ri(o) && !n && _a(e, o)) ? r = r.filter((e) => e !== o) : i = t, o = Zi(o);
	}
	return t.set(e, r), r;
}
function ya(e) {
	let { element: t, boundary: n, rootBoundary: r, strategy: i } = e, a = [...n === "clippingAncestors" ? Bi(t) ? [] : va(t, this._c) : [].concat(n), r], o = ga(t, a[0], i), s = o.top, c = o.right, l = o.bottom, u = o.left;
	for (let e = 1; e < a.length; e++) {
		let n = ga(t, a[e], i);
		s = Ur(n.top, s), c = Hr(n.right, c), l = Hr(n.bottom, l), u = Ur(n.left, u);
	}
	return {
		width: c - u,
		height: l - s,
...
function xa(e, t, n) {
	let r = Ii(t), i = Ni(t), a = n === "fixed", o = sa(e, !0, a, t), s = {
		scrollLeft: 0,
		scrollTop: 0
	}, c = Kr(0);
	function l() {
	...
	if (r || !r && !a) if ((ji(t) !== "body" || Ri(i)) && (s = Xi(t)), r) {
		let e = sa(t, !0, a, t);
		c.x = e.x + t.clientLeft, c.y = e.y + t.clientTop;
	} else i && l();
	a && !r && i && l();
	let u = i && !r && !a ? la(i, s) : Kr(0);
	return {
...
function Sa(e) {
	return Yi(e).position === "static";
}
function Ca(e, t) {
	if (!Ii(e) || Yi(e).position === "fixed") return null;
	if (t) return t(e);
...
function wa(e, t) {
	...
	if (!Ii(e)) {
		let t = Zi(e);
		for (; t && !Ji(t);) {
			if (Fi(t) && !Sa(t)) return t;
			t = Zi(t);
		}
		return n;
	}
	let r = Ca(e, t);
	for (; r && zi(r) && Sa(r);) r = Ca(r, t);
	return r && Ji(r) && Sa(r) && !Gi(r) ? n : r || Ki(e) || n;
}
var Ta = async function(e) {
	let t = this.getOffsetParent || wa, n = this.getDimensions, r = await n(e.floating);
	return {
...
function ka(e, t) {
	...
	function o(s, c) {
		...
		if (s || t(), !f || !p) return;
		let m = Gr(d), h = Gr(i.clientWidth - (u + f)), g = Gr(i.clientHeight - (d + p)), _ = Gr(u), v = {
			rootMargin: -m + "px " + -h + "px " + -g + "px " + -_ + "px",
			threshold: Ur(0, Hr(1, c)) || 1
		}, y = !0;
		function b(t) {
...
function Aa(e, t, n, r) {
	r === void 0 && (r = {});
	let { ancestorScroll: i = !0, ancestorResize: a = !0, elementResize: o = typeof ResizeObserver == "function", layoutShift: s = typeof IntersectionObserver == "function", animationFrame: c = !1 } = r, l = na(e), u = i || a ? [...l ? $i(l) : [], ...t ? $i(t) : []] : [];
	u.forEach((e) => {
...
var ja = Ei, Ma = Di, Na = bi, Pa = ki, Fa = Ci, Ia = yi, La = Oi, Ra = (e, t, n) => {
...
}, za = typeof document < "u" ? c : function() {};
function Ba(e, t) {
	if (e === t) return !0;
...
eo.displayName = $a;
var to = eo, no = "Popper", [ro, io] = ke(no), [ao, oo] = ro(no), so = (t) => {
...
so.displayName = no;
var co = "PopperAnchor", lo = e.forwardRef((t, n) => {
	let { __scopePopper: r, virtualRef: i, ...a } = t, o = oo(co, r), s = e.useRef(null), c = H(n, s), l = e.useRef(null);
	return e.useEffect(() => {
		let e = l.current;
...
lo.displayName = co;
var uo = "PopperContent", [fo, po] = ro(uo), mo = e.forwardRef((t, n) => {
	let { __scopePopper: r, side: i = "bottom", sideOffset: a = 0, align: o = "center", alignOffset: s = 0, arrowPadding: c = 0, avoidCollisions: l = !0, collisionBoundary: u = [], collisionPadding: d = 0, sticky: f = "partial", hideWhenDetached: m = !1, updatePositionStrategy: h = "optimized", onPlaced: g, ..._ } = t, v = oo(uo, r), [y, b] = e.useState(null), x = H(n, (e) => b(e)), [S, C] = e.useState(null), w = vt(S), T = w?.width ?? 0, E = w?.height ?? 0, D = i + (o === "center" ? "" : "-" + o), O = typeof d == "number" ? d : {
		top: 0,
		right: 0,
		bottom: 0,
		left: 0,
		...
		padding: O,
		boundary: k.filter(vo),
		altBoundary: A
	}, { refs: M, floatingStyles: N, placement: P, isPositioned: F, middlewareData: I } = Wa({
		strategy: "fixed",
		placement: D,
		whileElementsMounted: (...e) => Aa(...e, { animationFrame: h === "always" }),
...
mo.displayName = uo;
var ho = "PopperArrow", go = {
	top: "bottom",
	right: "left",
	bottom: "top",
	left: "right"
}, _o = e.forwardRef(function(e, t) {
	let { __scopePopper: n, ...r } = e, i = po(ho, n), a = go[i.placedSide];
...
var yo = (e) => ({
	...
	options: e,
	fn(t) {
		let { placement: n, rects: r, middlewareData: i } = t, a = i.arrow?.centerOffset !== 0, o = a ? 0 : e.arrowWidth, s = a ? 0 : e.arrowHeight, [c, l] = bo(n), u = {
			start: "0%",
			center: "50%",
			end: "100%"
...
var xo = so, So = lo, Co = mo, wo = _o, To = "Portal", Eo = e.forwardRef((t, n) => {
...
var Do = function(e) {
...
}, Oo = /* @__PURE__ */ new WeakMap(), ko = /* @__PURE__ */ new WeakMap(), Ao = {}, jo = 0, Mo = function(e) {
	...
	var i = No(t, Array.isArray(e) ? e : [e]);
	Ao[n] || (Ao[n] = /* @__PURE__ */ new WeakMap());
	var a = Ao[n], o = [], s = /* @__PURE__ */ new Set(), c = new Set(i), l = function(e) {
	...
	var u = function(e) {
		!e || c.has(e) || Array.prototype.forEach.call(e.children, function(e) {
			if (s.has(e)) u(e);
				...
				var t = e.getAttribute(r), i = t !== null && t !== "false", c = (Oo.get(e) || 0) + 1, l = (a.get(e) || 0) + 1;
				Oo.set(e, c), a.set(e, l), o.push(e), c === 1 && i && ko.set(e, !0), l === 1 && e.setAttribute(n, "true"), i || e.setAttribute(r, "true");
			} catch (t) {
	...
	return u(t), s.clear(), jo++, function() {
		o.forEach(function(e) {
			var t = Oo.get(e) - 1, i = a.get(e) - 1;
			Oo.set(e, t), a.set(e, i), t || (ko.has(e) || e.removeAttribute(r), ko.delete(e)), i || e.removeAttribute(n);
		}), jo--, jo || (Oo = /* @__PURE__ */ new WeakMap(), Oo = /* @__PURE__ */ new WeakMap(), ko = /* @__PURE__ */ new WeakMap(), Ao = {});
	};
}, Fo = function(e, t, n) {
	n === void 0 && (n = "data-aria-hidden");
	var r = Array.from(Array.isArray(e) ? e : [e]), i = t || Do(e);
	return i ? (r.push.apply(r, Array.from(i.querySelectorAll("[aria-live], script"))), Po(r, i, n, "aria-hidden")) : function() {
		return null;
	};
}, Io = function() {
...
var zo = "right-scroll-bar-position", Bo = "width-before-scroll-bar", Vo = "with-scroll-bars-hidden", Ho = "--removed-body-scroll-bar-size";
//#endregion
...
var Go = typeof window < "u" ? e.useLayoutEffect : e.useEffect, Ko = /* @__PURE__ */ new WeakMap();
function qo(e, t) {
...
var $o = Xo(), es = function() {}, ts = e.forwardRef(function(t, n) {
	var r = e.useRef(null), i = e.useState({
		onScrollCapture: es,
		onWheelCapture: es,
		onTouchMoveCapture: es
	}), a = i[0], o = i[1], s = t.forwardProps, c = t.children, l = t.className, u = t.removeScrollBar, d = t.enabled, f = t.shards, p = t.sideCar, m = t.noRelative, h = t.noIsolation, g = t.inert, _ = t.allowPinchZoom, v = t.as, y = v === void 0 ? "div" : v, b = t.gapMode, x = Lo(t, [
		"forwardProps",
		"children",
		"className",
		"removeScrollBar",
	...
	return e.createElement(e.Fragment, null, d && e.createElement(S, {
		...
		lockRef: r,
		gapMode: b
	}), s ? e.cloneElement(e.Children.only(c), Io(Io({}, w), { ref: C })) : e.createElement(y, Io({}, w, {
		className: l,
		ref: C
	}), c));
});
...
`;
	...
	return e.createElement(ms, { styles: gs(o, !n, a, r ? "" : "!important") });
}, bs = !1;
...
function Vs(t) {
	var n = e.useRef([]), r = e.useRef([0, 0]), i = e.useRef(), a = e.useState(zs++)[0], o = e.useState(ls)[0], s = e.useRef(t);
	e.useEffect(function() {
		s.current = t;
	}, [t]), e.useEffect(function() {
		if (t.inert) {
			document.body.classList.add(`block-interactivity-${a}`);
			var e = Ro([t.lockRef.current], (t.shards || []).map(Is), !0).filter(Boolean);
			return e.forEach(function(e) {
	...
	var c = e.useCallback(function(e, t) {
		...
		var n = Ps(e), a = r.current, o = "deltaX" in e ? e.deltaX : a[0] - n[0], c = "deltaY" in e ? e.deltaY : a[1] - n[1], l, u = e.target, d = Math.abs(o) > Math.abs(c) ? "h" : "v";
		...
		var h = i.current || l;
		return Ns(h, t, e, h === "h" ? o : c, !0);
	}, []), l = e.useCallback(function(e) {
		var t = e;
		if (!(!Bs.length || Bs[Bs.length - 1] !== o)) {
			var r = "deltaY" in t ? Fs(t) : Ps(t), i = n.current.filter(function(e) {
				return e.name === t.type && (e.target === t.target || t.target === e.shadowParent) && Ls(e.delta, r);
			})[0];
			if (i && i.should) {
			...
			if (!i) {
				var a = (s.current.shards || []).map(Is).filter(Boolean).filter(function(e) {
		...
		r.current = Ps(e), i.current = void 0;
	}, []), f = e.useCallback(function(e) {
		u(e.type, Fs(e), e.target, c(e, t.lockRef.current));
	}, []), p = e.useCallback(function(e) {
		u(e.type, Ps(e), e.target, c(e, t.lockRef.current));
	}, []);
	e.useEffect(function() {
		return Bs.push(o), t.setCallbacks({
			onScrollCapture: f,
			onWheelCapture: f,
			onTouchMoveCapture: p
		}), document.addEventListener("wheel", l, Ss), document.addEventListener("touchmove", l, Ss), document.addEventListener("touchstart", d, Ss), function() {
			Bs = Bs.filter(function(e) {
				return e !== o;
			}), document.removeEventListener("wheel", l, Ss), document.removeEventListener("touchmove", l, Ss), document.removeEventListener("touchstart", d, Ss);
		};
	}, []);
	var m = t.removeScrollBar, h = t.inert;
	return e.createElement(e.Fragment, null, h ? e.createElement(o, { styles: Rs(a) }) : null, m ? e.createElement(ys, {
...
var Us = Qo($o, Vs), Ws = e.forwardRef(function(t, n) {
	return e.createElement(ts, Io({}, t, {
		ref: n,
		sideCar: Us
	}));
});
Ws.classNames = ts.classNames;
//#endregion
//#region node_modules/@radix-ui/react-popover/dist/index.mjs
var Gs = "Popover", [Ks, qs] = ke(Gs, [io]), Js = io(), [Ys, Xs] = Ks(Gs), Zs = (t) => {
	let { __scopePopover: n, children: r, open: i, defaultOpen: a, onOpenChange: o, modal: s = !1 } = t, c = Js(n), l = e.useRef(null), [u, d] = e.useState(!1), [f, m] = Ke({
		prop: i,
		defaultProp: a ?? !1,
		onChange: o,
		caller: Gs
...
Zs.displayName = Gs;
var Qs = "PopoverAnchor", $s = e.forwardRef((t, n) => {
	let { __scopePopover: r, ...i } = t, a = Xs(Qs, r), o = Js(r), { onCustomAnchorAdd: s, onCustomAnchorRemove: c } = a;
	return e.useEffect(() => (s(), () => c()), [s, c]), /* @__PURE__ */ p(So, {
		...o,
		...i,
		ref: n
	});
...
$s.displayName = Qs;
var ec = "PopoverTrigger", tc = e.forwardRef((e, t) => {
	let { __scopePopover: n, ...r } = e, i = Xs(ec, n), a = Js(n), o = H(t, i.triggerRef), s = /* @__PURE__ */ p(U.button, {
		type: "button",
	...
	return i.hasCustomAnchor ? s : /* @__PURE__ */ p(So, {
		asChild: !0,
		...a,
		children: s
	});
...
tc.displayName = ec;
var nc = "PopoverPortal", [rc, ic] = Ks(nc, { forceMount: void 0 }), ac = (e) => {
	let { __scopePopover: t, forceMount: n, children: r, container: i } = e, a = Xs(nc, t);
...
ac.displayName = nc;
var oc = "PopoverContent", sc = e.forwardRef((e, t) => {
	let n = ic(oc, e.__scopePopover), { forceMount: r = n.forceMount, ...i } = e, a = Xs(oc, e.__scopePopover);
	return /* @__PURE__ */ p(xt, {
		present: r || a.open,
		children: a.modal ? /* @__PURE__ */ p(lc, {
			...i,
			ref: t
		}) : /* @__PURE__ */ p(uc, {
			...i,
...
sc.displayName = oc;
var cc = /* @__PURE__ */ je("PopoverContent.RemoveScroll"), lc = e.forwardRef((t, n) => {
	let r = Xs(oc, t.__scopePopover), i = e.useRef(null), a = H(n, i), o = e.useRef(!1);
	return e.useEffect(() => {
		let e = i.current;
		if (e) return Fo(e);
	}, []), /* @__PURE__ */ p(Ws, {
	...
	let r = Xs(oc, t.__scopePopover), i = e.useRef(!1), a = e.useRef(!1);
	...
	let { __scopePopover: n, trapFocus: r, onOpenAutoFocus: i, onCloseAutoFocus: a, disableOutsidePointerEvents: o, onEscapeKeyDown: s, onPointerDownOutside: c, onFocusOutside: l, onInteractOutside: u, ...d } = e, f = Xs(oc, n), m = Js(n);
	return Cr(), /* @__PURE__ */ p(kr, {
		asChild: !0,
		loop: !0,
		trapped: r,
		onMountAutoFocus: i,
		...
		children: /* @__PURE__ */ p(hr, {
			...
			children: /* @__PURE__ */ p(Co, {
				"data-state": gc(f.open),
				role: "dialog",
				id: f.contentId,
				...m,
				...d,
...
}), fc = "PopoverClose", pc = e.forwardRef((e, t) => {
	let { __scopePopover: n, ...r } = e, i = Xs(fc, n);
...
pc.displayName = fc;
var mc = "PopoverArrow", hc = e.forwardRef((e, t) => {
...
function Sc({ options: t, value: n, onChange: r, label: i, error: a, placeholder: o = "Selecione...", className: s, disabled: c }) {
	let [l, u] = e.useState(!1), [d, h] = e.useState(""), g = t.find((e) => e.value === n), _ = d.trim().toLowerCase(), v = _ ? t.filter((e) => e.label.toLowerCase().includes(_)) : t, y = v.slice(0, xc), b = (e) => {
		r?.(e), u(!1), h("");
	};
	return /* @__PURE__ */ m("div", {
		...
		children: [
			...
			/* @__PURE__ */ m(_c, {
				...
				}), /* @__PURE__ */ p(yc, { children: /* @__PURE__ */ m(bc, {
					...
					children: [/* @__PURE__ */ p("div", {
						...
						children: y.length > 0 ? /* @__PURE__ */ m(f, { children: [y.map((e) => /* @__PURE__ */ m("button", {
							...
							children: [/* @__PURE__ */ p("span", {
								...
								children: e.value === n && /* @__PURE__ */ p(z, { size: 15 })
							}), /* @__PURE__ */ p("span", {
								className: W.searchItemLabel,
								children: e.label
							})]
						}, e.value)), v.length > xc && /* @__PURE__ */ m("div", {
...
}, wc = i(({ className: e, onFileSelect: t, accept: n, maxSize: r = 5 * 1024 * 1024, label: i, error: a, id: o, ...s }, c) => {
	let [l, f] = d("idle"), [h, g] = d(null), [_, v] = d(""), y = u(null), b = !!a || !!_, S = a || _, C = o || (i ? `fileupload-${i.replace(/\s+/g, "-").toLowerCase()}` : void 0), w = (e) => {
		if (r && e.size > r) {
			f("error"), v(`O arquivo excede o limite de ${Cc(r)}`);
			return;
		}
...
var Tc = Object.freeze({
	...
	whiteSpace: "nowrap",
	wordWrap: "normal"
}), Ec = "VisuallyHidden", Dc = e.forwardRef((e, t) => /* @__PURE__ */ p(U.span, {
	...e,
	ref: t,
	style: {
		...Tc,
...
var Oc = Dc, kc = [
	...
	"ArrowUp",
	"ArrowDown"
], Ac = [" ", "Enter"], jc = "Select", [Mc, Nc, Pc] = ze(jc), [Fc, Ic] = ke(jc, [Pc, io]), Lc = io(), [Rc, zc] = Fc(jc), [Bc, Vc] = Fc(jc), Hc = (t) => {
	let { __scopeSelect: n, children: r, open: i, defaultOpen: a, onOpenChange: o, value: s, defaultValue: c, onValueChange: l, dir: u, name: d, autoComplete: f, disabled: h, required: g, form: _ } = t, v = Lc(n), [y, b] = e.useState(null), [x, S] = e.useState(null), [C, w] = e.useState(!1), T = Xe(u), [E, D] = Ke({
		prop: i,
		defaultProp: a ?? !1,
		onChange: o,
		caller: jc
	...
	return /* @__PURE__ */ p(xo, {
		...
		children: /* @__PURE__ */ m(Rc, {
			...
			disabled: h,
			children: [/* @__PURE__ */ p(Mc.Provider, {
				scope: n,
...
Hc.displayName = jc;
var Uc = "SelectTrigger", Wc = e.forwardRef((t, n) => {
	let { __scopeSelect: r, disabled: i = !1, ...a } = t, o = Lc(r), s = zc(Uc, r), c = s.disabled || i, l = H(n, s.onTriggerChange), u = Nc(r), d = e.useRef("touch"), [f, m, h] = zl((e) => {
		let t = u().filter((e) => !e.disabled), n = Bl(t, e, t.find((e) => e.value === s.value));
	...
	return /* @__PURE__ */ p(So, {
		...
		children: /* @__PURE__ */ p(U.button, {
			...
			disabled: c,
			"data-disabled": c ? "" : void 0,
			"data-placeholder": Rl(s.value) ? "" : void 0,
			...a,
			ref: l,
...
Wc.displayName = Uc;
var Gc = "SelectValue", Kc = e.forwardRef((e, t) => {
	let { __scopeSelect: n, className: r, style: i, children: a, placeholder: o = "", ...s } = e, c = zc(Gc, n), { onValueNodeHasChildrenChange: l } = c, u = a !== void 0, d = H(t, c.onValueNodeChange);
	return Be(() => {
		l(u);
		...
		children: Rl(c.value) ? /* @__PURE__ */ p(f, { children: o }) : a
	});
});
Kc.displayName = Gc;
var qc = "SelectIcon", Jc = e.forwardRef((e, t) => {
...
Jc.displayName = qc;
var Yc = "SelectPortal", Xc = (e) => /* @__PURE__ */ p(Eo, {
	asChild: !0,
	...e
});
Xc.displayName = Yc;
var Zc = "SelectContent", Qc = e.forwardRef((t, n) => {
	let r = zc(Zc, t.__scopeSelect), [i, a] = e.useState();
	if (Be(() => {
		a(new DocumentFragment());
	}, []), !r.open) {
		let e = i;
		return e ? h.createPortal(/* @__PURE__ */ p(el, {
			scope: t.__scopeSelect,
			children: /* @__PURE__ */ p(Mc.Slot, {
				scope: t.__scopeSelect,
...
Qc.displayName = Zc;
var $c = 10, [el, tl] = Fc(Zc), nl = "SelectContentImpl", rl = /* @__PURE__ */ je("SelectContent.RemoveScroll"), il = e.forwardRef((t, n) => {
	let { __scopeSelect: r, position: i = "item-aligned", onCloseAutoFocus: a, onEscapeKeyDown: o, onPointerDownOutside: s, side: c, sideOffset: l, align: u, alignOffset: d, arrowPadding: f, collisionBoundary: m, collisionPadding: h, sticky: g, hideWhenDetached: _, avoidCollisions: v, ...y } = t, b = zc(Zc, r), [x, S] = e.useState(null), [C, w] = e.useState(null), T = H(n, (e) => S(e)), [E, D] = e.useState(null), [O, k] = e.useState(null), A = Nc(r), [j, M] = e.useState(!1), N = e.useRef(!1);
	e.useEffect(() => {
		if (x) return Fo(x);
	}, [x]), Cr();
	...
	let [ee, R] = zl((e) => {
		let t = A().filter((e) => !e.disabled), n = Bl(t, e, t.find((e) => e.ref.current === document.activeElement));
	...
	}, [b.value]), re = i === "popper" ? cl : ol, ie = re === cl ? {
		side: c,
		sideOffset: l,
		align: u,
		alignOffset: d,
...
il.displayName = nl;
var al = "SelectItemAlignedPosition", ol = e.forwardRef((t, n) => {
	let { __scopeSelect: r, onPlaced: i, ...a } = t, o = zc(Zc, r), s = tl(Zc, r), [c, l] = e.useState(null), [u, d] = e.useState(null), f = H(n, (e) => d(e)), m = Nc(r), h = e.useRef(!1), g = e.useRef(!0), { viewport: _, selectedItem: v, selectedItemText: y, focusSelectedItem: b } = s, x = e.useCallback(() => {
		if (o.trigger && o.valueNode && c && u && _ && v && y) {
			...
			if (o.dir !== "rtl") {
				let i = r.left - t.left, a = n.left - i, o = e.left - a, s = e.width + o, l = Math.max(s, t.width), u = window.innerWidth - $c, d = tn(a, [$c, Math.max($c, u - l)]);
				c.style.minWidth = s + "px", c.style.left = d + "px";
			} else {
				let i = t.right - r.right, a = window.innerWidth - n.right - i, o = window.innerWidth - e.right - a, s = e.width + o, l = Math.max(s, t.width), u = window.innerWidth - $c, d = tn(a, [$c, Math.max($c, u - l)]);
				c.style.minWidth = s + "px", c.style.right = d + "px";
			}
			let a = m(), s = window.innerHeight - $c * 2, l = _.scrollHeight, d = window.getComputedStyle(u), f = parseInt(d.borderTopWidth, 10), p = parseInt(d.paddingTop, 10), g = parseInt(d.borderBottomWidth, 10), b = parseInt(d.paddingBottom, 10), x = f + p + l + b + g, S = Math.min(v.offsetHeight * 5, x), C = window.getComputedStyle(_), w = parseInt(C.paddingTop, 10), T = parseInt(C.paddingBottom, 10), E = e.top + e.height / 2 - $c, D = s - E, O = v.offsetHeight / 2, k = v.offsetTop + O, A = f + p + k, j = x - A;
			if (A <= E) {
			...
			c.style.margin = `${$c}px 0`, c.style.minHeight = S + "px", c.style.maxHeight = s + "px", i?.(), requestAnimationFrame(() => h.current = !0);
		}
	}, [
		m,
		o.trigger,
...
ol.displayName = al;
var sl = "SelectPopperPosition", cl = e.forwardRef((e, t) => {
	let { __scopeSelect: n, align: r = "start", collisionPadding: i = $c, ...a } = e;
...
cl.displayName = sl;
var [ll, ul] = Fc(Zc, {}), dl = "SelectViewport", fl = e.forwardRef((t, n) => {
	let { __scopeSelect: r, nonce: i, ...a } = t, o = tl(dl, r), s = ul(dl, r), c = H(n, o.onViewportChange), l = e.useRef(0);
		...
		children: /* @__PURE__ */ p(U.div, {
			...
			onScroll: V(a.onScroll, (e) => {
				...
				if (r?.current && n) {
					...
					if (e > 0) {
						let r = window.innerHeight - $c * 2, i = parseFloat(n.style.minHeight), a = parseFloat(n.style.height), o = Math.max(i, a);
						if (o < r) {
...
fl.displayName = dl;
var pl = "SelectGroup", [ml, hl] = Fc(pl), gl = e.forwardRef((e, t) => {
...
gl.displayName = pl;
var _l = "SelectLabel", vl = e.forwardRef((e, t) => {
	let { __scopeSelect: n, ...r } = e, i = hl(_l, n);
	return /* @__PURE__ */ p(U.div, {
		id: i.id,
		...r,
		ref: t
...
vl.displayName = _l;
var yl = "SelectItem", [bl, xl] = Fc(yl), Sl = e.forwardRef((t, n) => {
	let { __scopeSelect: r, value: i, disabled: a = !1, textValue: o, ...s } = t, c = zc(yl, r), l = tl(yl, r), u = c.value === i, [d, f] = e.useState(o ?? ""), [m, h] = e.useState(!1), g = H(n, (e) => l.itemRefCallback?.(e, i, a)), _ = Ue(), v = e.useRef("touch"), y = () => {
	...
	return /* @__PURE__ */ p(bl, {
		...
		children: /* @__PURE__ */ p(Mc.ItemSlot, {
			scope: r,
			value: i,
			disabled: a,
			textValue: d,
			children: /* @__PURE__ */ p(U.div, {
				...
				onKeyDown: V(s.onKeyDown, (e) => {
					l.searchRef?.current !== "" && e.key === " " || (Ac.includes(e.key) && y(), e.key === " " && e.preventDefault());
				})
			})
		})
	});
...
Sl.displayName = yl;
var Cl = "SelectItemText", wl = e.forwardRef((t, n) => {
	let { __scopeSelect: r, className: i, style: a, ...o } = t, s = zc(Cl, r), c = tl(Cl, r), l = xl(Cl, r), u = Vc(Cl, r), [d, g] = e.useState(null), _ = H(n, (e) => g(e), l.onItemTextChange, (e) => c.itemTextRefCallback?.(e, l.value, l.disabled)), v = d?.textContent, y = e.useMemo(() => /* @__PURE__ */ p("option", {
		value: l.value,
		disabled: l.disabled,
		children: v
	}, l.value), [
...
wl.displayName = Cl;
var Tl = "SelectItemIndicator", El = e.forwardRef((e, t) => {
	let { __scopeSelect: n, ...r } = e;
	return xl(Tl, n).isSelected ? /* @__PURE__ */ p(U.span, {
		"aria-hidden": !0,
		...r,
		ref: t
	}) : null;
...
El.displayName = Tl;
var Dl = "SelectScrollUpButton", Ol = e.forwardRef((t, n) => {
	let r = tl(Dl, t.__scopeSelect), i = ul(Dl, t.__scopeSelect), [a, o] = e.useState(!1), s = H(n, i.onScrollButtonChange);
	return Be(() => {
...
Ol.displayName = Dl;
var kl = "SelectScrollDownButton", Al = e.forwardRef((t, n) => {
	let r = tl(kl, t.__scopeSelect), i = ul(kl, t.__scopeSelect), [a, o] = e.useState(!1), s = H(n, i.onScrollButtonChange);
	return Be(() => {
		if (r.viewport && r.isPositioned) {
			let e = function() {
...
var jl = e.forwardRef((t, n) => {
	let { __scopeSelect: r, onAutoScroll: i, ...a } = t, o = tl("SelectScrollButton", r), s = e.useRef(null), c = Nc(r), l = e.useCallback(() => {
...
}), Ml = "SelectSeparator", Nl = e.forwardRef((e, t) => {
	let { __scopeSelect: n, ...r } = e;
	return /* @__PURE__ */ p(U.div, {
		"aria-hidden": !0,
		...r,
...
Nl.displayName = Ml;
var Pl = "SelectArrow", Fl = e.forwardRef((e, t) => {
	let { __scopeSelect: n, ...r } = e, i = Lc(n), a = zc(Pl, n), o = tl(Pl, n);
	return a.open && o.position === "popper" ? /* @__PURE__ */ p(wo, {
		...i,
		...r,
		ref: t
	}) : null;
...
Fl.displayName = Pl;
var Il = "SelectBubbleInput", Ll = e.forwardRef(({ __scopeSelect: t, value: n, ...r }, i) => {
	let a = e.useRef(null), o = H(i, a), s = yt(n);
	return e.useEffect(() => {
		let e = a.current;
		if (!e) return;
...
function Bl(e, t, n) {
	let r = t.length > 1 && Array.from(t).every((e) => e === t[0]) ? t[0] : t, i = n ? e.indexOf(n) : -1, a = Vl(e, Math.max(i, 0));
...
var Hl = Hc, Ul = Wc, Wl = Kc, Gl = Jc, Kl = Xc, ql = Qc, Jl = fl, Yl = Sl, Xl = wl, Zl = El, K = {
	...
	return /* @__PURE__ */ p("div", {
		...
		children: t.map((n, r) => {
			...
			return /* @__PURE__ */ m(e.Fragment, { children: [/* @__PURE__ */ m("div", {
				...
				children: [n.label && /* @__PURE__ */ p(D, {
				...
				}) : n.options.length > Ql ? /* @__PURE__ */ p($l, { level: n }) : /* @__PURE__ */ m(Hl, {
					value: n.value,
					...
					children: [/* @__PURE__ */ m(Ul, {
						...
						children: [/* @__PURE__ */ m("div", {
							...
							}), /* @__PURE__ */ p(Wl, { placeholder: n.placeholder || "Selecione..." })]
						}), /* @__PURE__ */ p(Gl, {
							asChild: !0,
					...
					}), /* @__PURE__ */ p(Kl, { children: /* @__PURE__ */ p(ql, {
						className: K.content,
						position: "popper",
						sideOffset: 4,
						children: /* @__PURE__ */ p(Jl, {
							...
							children: n.options.map((e) => /* @__PURE__ */ m(Yl, {
								...
								children: [/* @__PURE__ */ p("span", {
									...
									children: /* @__PURE__ */ p(Zl, { children: /* @__PURE__ */ p(z, { size: 16 }) })
								}), /* @__PURE__ */ p(Xl, { children: e.label })]
							}, e.value))
						})
					}) })]
				})]
...
var ru = ["Enter", " "], iu = [
	...
	io,
	it
]), hu = io(), gu = it(), [_u, vu] = pu(lu), [yu, bu] = pu(lu), xu = (t) => {
...
var Ou = "MenuContent", [ku, Au] = pu(Ou), ju = e.forwardRef((e, t) => {
	...
	let r = vu(Ou, t.__scopeMenu), i = e.useRef(null), a = H(n, i);
	return e.useEffect(() => {
		let e = i.current;
		if (e) return Fo(e);
	}, []), /* @__PURE__ */ p(Fu, {
	...
	let { __scopeMenu: r, loop: i = !1, trapFocus: a, onOpenAutoFocus: o, onCloseAutoFocus: s, disableOutsidePointerEvents: c, onEntryFocus: l, onEscapeKeyDown: u, onPointerDownOutside: d, onFocusOutside: f, onInteractOutside: m, onDismiss: h, disableOutsideScroll: g, ..._ } = t, v = vu(Ou, r), y = bu(Ou, r), b = hu(r), x = gu(r), S = du(r), [C, w] = e.useState(null), T = e.useRef(null), E = H(n, T, v.onContentChange), D = e.useRef(0), O = e.useRef(""), k = e.useRef(0), A = e.useRef(null), j = e.useRef("right"), M = e.useRef(0), N = g ? Ws : e.Fragment, P = g ? {
		as: Pu,
		allowPinchZoom: !0
	} : void 0, F = (e) => {
	...
	e.useEffect(() => () => window.clearTimeout(D.current), []), Cr();
				...
				children: /* @__PURE__ */ p(hr, {
					...
					children: /* @__PURE__ */ p(gt, {
						...
						children: /* @__PURE__ */ p(Co, {
							...
							onPointerMove: V(t.onPointerMove, Sd((e) => {
...
var Bu = "MenuItem", Vu = "menu.itemSelect", Hu = e.forwardRef((t, n) => {
	let { disabled: r = !1, onSelect: i, ...a } = t, o = e.useRef(null), s = bu(Bu, t.__scopeMenu), c = Au(Bu, t.__scopeMenu), l = H(n, o), u = e.useRef(!1), d = () => {
		let e = o.current;
		if (!r && e) {
...
var Uu = e.forwardRef((t, n) => {
	let { __scopeMenu: r, disabled: i = !1, textValue: a, ...o } = t, s = Au(Bu, r), c = gu(r), l = e.useRef(null), u = H(n, l), [d, f] = e.useState(!1), [m, h] = e.useState("");
	return e.useEffect(() => {
		let e = l.current;
		...
		children: /* @__PURE__ */ p(_t, {
			...
			children: /* @__PURE__ */ p(U.div, {
				...
				onPointerLeave: V(t.onPointerLeave, Sd((e) => s.onItemLeave(e))),
	...
	return /* @__PURE__ */ p($u, {
		...
		children: /* @__PURE__ */ p(Hu, {
			...
			ref: t,
			"data-state": gd(n),
			onSelect: V(i.onSelect, () => r?.(hd(n) ? !0 : !n), { checkForDefaultPrevented: !1 })
		})
	});
});
Gu.displayName = Wu;
...
var od = "MenuSub", [sd, cd] = pu(od), ld = (t) => {
	...
	return e.useEffect(() => (o.open === !1 && f(!1), () => f(!1)), [o.open, f]), /* @__PURE__ */ p(xo, {
		...s,
		children: /* @__PURE__ */ p(_u, {
			scope: n,
			open: i,
...
var ud = "MenuSubTrigger", dd = e.forwardRef((t, n) => {
	...
	return e.useEffect(() => d, [d]), e.useEffect(() => {
		...
		children: /* @__PURE__ */ p(Uu, {
			...
			onPointerLeave: V(t.onPointerLeave, Sd((e) => {
				d();
...
var fd = "MenuSubContent", pd = e.forwardRef((t, n) => {
	let r = Eu(Ou, t.__scopeMenu), { forceMount: i = r.forceMount, ...a } = t, o = vu(Ou, t.__scopeMenu), s = bu(Ou, t.__scopeMenu), c = cd(fd, t.__scopeMenu), l = e.useRef(null), u = H(n, l);
	return /* @__PURE__ */ p(uu.Provider, {
		scope: t.__scopeMenu,
		children: /* @__PURE__ */ p(xt, {
			present: i || o.open,
...
function u_(e) {
	...
	return t.createElement(vh.Provider, { value: Fe }, t.createElement(i.Root, {
		...
		let o = Cg(a, E, n.modifiersStyles), s = Wh(a, f, n.modifiersClassNames), l = !Se && !a.hidden ? de(r, a, c.options, c) : void 0;
...
}, m_ = _c, h_ = vc, g_ = e.forwardRef(({ className: e, align: t = "center", sideOffset: n = 4, ...r }, i) => /* @__PURE__ */ p(yc, { children: /* @__PURE__ */ p(bc, {
	ref: i,
	align: t,
	sideOffset: n,
...
}, [x_, S_] = ke("Tooltip", [io]), C_ = io(), w_ = "TooltipProvider", T_ = 700, E_ = "tooltip.open", [D_, O_] = x_(w_), k_ = (t) => {
...
var P_ = "TooltipTrigger", F_ = e.forwardRef((t, n) => {
	let { __scopeTooltip: r, ...i } = t, a = M_(P_, r), o = O_(P_, r), s = C_(r), c = H(n, e.useRef(null), a.onTriggerChange), l = e.useRef(!1), u = e.useRef(!1), d = e.useCallback(() => l.current = !1, []);
	return e.useEffect(() => () => document.removeEventListener("pointerup", d), [d]), /* @__PURE__ */ p(So, {
		asChild: !0,
		...s,
		children: /* @__PURE__ */ p(U.button, {
...
var B_ = "TooltipContent", V_ = e.forwardRef((e, t) => {
	...
	let r = M_(B_, t.__scopeTooltip), i = O_(B_, t.__scopeTooltip), a = e.useRef(null), o = H(n, a), [s, c] = e.useState(null), { trigger: l, onClose: u } = r, d = a.current, { onPointerInTransitChange: f } = i, m = e.useCallback(() => {
		c(null), f(!1);
...
var q_ = "TooltipArrow", J_ = e.forwardRef((e, t) => {
	...
	return W_(q_, n).isInside ? null : /* @__PURE__ */ p(wo, {
		...i,
		...r,
		ref: t
	});
...
var Lv = (e) => {
	...
	return /* @__PURE__ */ t.createElement("li", {
		...
		onPointerMove: (t) => {
			...
			let i = t.clientY - ye.current.y, a = t.clientX - ye.current.x, o = e.swipeDirections ?? Iv(x);
		...
		onClick: (e) => {
			Ev(r.cancel) && ue && (r.cancel.onClick == null || r.cancel.onClick.call(r.cancel, e), V());
		},
		...
		onClick: (e) => {
			Ev(r.action) && (r.action.onClick == null || r.action.onClick.call(r.action, e), !e.defaultPrevented && V());
		},
...
var Yv = "DialogTrigger", Xv = e.forwardRef((e, t) => {
	let { __scopeDialog: n, ...r } = e, i = qv(Yv, n), a = H(t, i.triggerRef);
	return /* @__PURE__ */ p(U.button, {
		type: "button",
		"aria-haspopup": "dialog",
		"aria-expanded": i.open,
...
var sy = e.forwardRef((t, n) => {
	let r = qv(ay, t.__scopeDialog), i = e.useRef(null), a = H(n, r.contentRef, i);
	return e.useEffect(() => {
		let e = i.current;
		if (e) return Fo(e);
	}, []), /* @__PURE__ */ p(ly, {
	...
	let { __scopeDialog: r, trapFocus: i, onOpenAutoFocus: a, onCloseAutoFocus: o, ...s } = t, c = qv(ay, r), l = e.useRef(null), u = H(n, l);
	return Cr(), /* @__PURE__ */ m(f, { children: [/* @__PURE__ */ p(kr, {
		asChild: !0,
		loop: !0,
		trapped: i,
		onMountAutoFocus: a,
...
var $ = {
	overlay: "_overlay_1wgt9_3",
	sidebar: "_sidebar_1wgt9_23",
	expanded: "_expanded_1wgt9_53",
	collapsed: "_collapsed_1wgt9_61",
	header: "_header_1wgt9_71",
	logoContainer: "_logoContainer_1wgt9_111",
	toggleButton: "_toggleButton_1wgt9_141",
	nav: "_nav_1wgt9_177",
	item: "_item_1wgt9_199",
	iconWrap: "_iconWrap_1wgt9_249",
	badge: "_badge_1wgt9_267",
	itemActive: "_itemActive_1wgt9_291",
	badgeDot: "_badgeDot_1wgt9_303",
	itemCollapsed: "_itemCollapsed_1wgt9_347",
	itemExpanded: "_itemExpanded_1wgt9_357",
	itemLabel: "_itemLabel_1wgt9_367",
	labelHidden: "_labelHidden_1wgt9_381",
	section: "_section_1wgt9_395",
	sectionCollapsed: "_sectionCollapsed_1wgt9_409",
	sectionLabel: "_sectionLabel_1wgt9_417",
	sectionRule: "_sectionRule_1wgt9_435",
	footer: "_footer_1wgt9_449",
	footerCollapsed: "_footerCollapsed_1wgt9_463",
	userRow: "_userRow_1wgt9_479",
	userRowCollapsed: "_userRowCollapsed_1wgt9_493",
	brandAvatar: "_brandAvatar_1wgt9_505",
	logoutButton: "_logoutButton_1wgt9_519",
	userInfo: "_userInfo_1wgt9_577",
	userName: "_userName_1wgt9_593",
	userRole: "_userRole_1wgt9_611",
	mobileOpen: "_mobileOpen_1wgt9_641",
	logoPlaceholder: "_logoPlaceholder_1wgt9_667",
	logoPulse: "_logoPulse_1wgt9_1"
}, cb = n({ isCollapsed: !1 });
function lb(e) {
...
function ub({ icon: e, label: t, active: n, badge: r, href: i, className: a, ...s }) {
	let { isCollapsed: c } = o(cb), l = /* @__PURE__ */ m(i ? "a" : "button", {
		href: i,
...
function fb({ isCollapsed: e, onToggle: t, isOpenMobile: n, onCloseMobile: r, logo: i, children: a, userName: o = "Usuário", userRole: s = "Colaborador", userAvatarUrl: c, onLogout: l, className: u, ...d }) {
	return /* @__PURE__ */ m(f, { children: [n && /* @__PURE__ */ p("div", {
		className: $.overlay,
		onClick: r
	}), /* @__PURE__ */ m("aside", {
		className: x($.sidebar, e ? $.collapsed : $.expanded, n && $.mobileOpen, u),
		...d,
		children: [
			/* @__PURE__ */ m("div", {
				className: $.header,
			...
			/* @__PURE__ */ p("div", {
				...
				children: /* @__PURE__ */ m("div", {
					className: x($.userRow, e && $.userRowCollapsed),
					children: [
						/* @__PURE__ */ p(M, {
							src: c,
							initials: lb(o),
	...
	return /* @__PURE__ */ m("header", {
		...
		children: [/* @__PURE__ */ p("div", {
			...
			children: /* @__PURE__ */ p(be, {
				...
				children: /* @__PURE__ */ p(de, { size: 20 })
			})
		}), /* @__PURE__ */ p("div", {
