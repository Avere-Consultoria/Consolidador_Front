...
export default function RedefinirSenha() {
    ...
    const inputStyle: React.CSSProperties = {
        ...
        border: '1px solid var(--color-border-default)', fontSize: '15px', color: 'var(--color-text-primary)', outline: 'none',
    };
            ...
            <div style={{ width: '100%', maxWidth: '400px', background: 'var(--color-white)', borderRadius: '14px', padding: '40px 32px', boxShadow: '0 10px 30px var(--color-border-subtle)' }}>
                ...
                {verificando ? (
                    ...
                    <div style={{ textAlign: 'center' }}>
                        <Typography variant="p" style={{ fontSize: '14px', color: 'var(--color-danger-solid)', marginBottom: '16px' }}>
                    ...
                    <div style={{ background: 'rgba(16,185,129,0.08)', border: '1px solid rgba(16,185,129,0.25)', borderRadius: '8px', padding: '14px', textAlign: 'center' }}>
                        <Typography variant="p" style={{ fontSize: '14px', color: 'var(--color-success-text)', fontWeight: 600 }}>
                    ...
                    <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
                        <div style={{ position: 'relative' }}>
                            <div style={{ position: 'absolute', top: '50%', transform: 'translateY(-50%)', left: '14px', color: 'var(--color-text-muted)' }}><Lock size={18} /></div>
                        ...
                        {errorMsg && (
                            <Typography variant="p" style={{ fontSize: '13px', color: 'var(--color-danger-solid)', fontWeight: 500, margin: 0 }}>{errorMsg}</Typography>
                        )}
