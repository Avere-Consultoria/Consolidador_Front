            ...
            >
                ...
                <div style={{ padding: '20px 24px', borderBottom: '1px solid var(--color-border-subtle)', display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', gap: '16px', flexShrink: 0 }}>
                    <div style={{ flex: 1 }}>
                        ...
                        <Typography variant="p" style={{ fontSize: '12px', color: 'var(--color-text-secondary)', marginTop: '4px' }}>
                ...
                {/* ── Filtros ── */}
                <div style={{ padding: '14px 24px', borderBottom: '1px solid var(--color-border-subtle)', display: 'flex', gap: '8px', flexWrap: 'wrap', alignItems: 'center', flexShrink: 0, background: 'var(--gray-50)' }}>
                    <Typography variant="p" style={{ fontSize: '11px', fontWeight: 700, color: 'var(--color-text-secondary)', textTransform: 'uppercase', letterSpacing: '0.05em', marginRight: '6px' }}>
                        Filtros:
                    </Typography>
                                    ...
                                    return (
                                        <div style={{ display: 'flex', flexDirection: 'column', gap: '3px' }}>
                                            ...
                                            <div style={{ display: 'flex', gap: '6px', alignItems: 'center' }}>
                                                <span style={{ background: cor.bg, color: cor.fg, fontSize: '9px', fontWeight: 700, padding: '2px 6px', borderRadius: '4px' }}>
                                                    {item.instituicao}
                                                </span>
                                                {item.emissor_nome && (
                                                    <Typography variant="p" style={{ fontSize: '11px', color: 'var(--color-text-secondary)' }}>
                                                        {item.emissor_nome}
                                                    </Typography>
                                                )}
                                            </div>
                            ...
                            },
                            {
                                ...
                                cell: (item: PosicaoFechadaDrawer) => (
                                    item.classe_avere
                                        ...
                                        : <span style={{ color: 'var(--color-text-muted)', fontSize: '12px', fontStyle: 'italic' }}>—</span>
                                ),
                            },
                            {
                                header: 'Liquidez',
                ...
                {/* ── Rodapé ── */}
                <div style={{ padding: '12px 24px', background: 'var(--gray-50)', borderTop: '1px solid var(--color-border-subtle)', display: 'flex', justifyContent: 'flex-end', borderBottomLeftRadius: '14px', borderBottomRightRadius: '14px', flexShrink: 0 }}>
