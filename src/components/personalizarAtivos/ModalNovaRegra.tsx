...
export function ModalNovaRegra({
    ...
    return (
        ...
        >
            <div
                style={{ background: 'var(--color-white)', borderRadius: '14px', width: '100%', maxWidth: '580px', maxHeight: '90vh', display: 'flex', flexDirection: 'column', boxShadow: '0 24px 48px var(--color-border-default)' }}
            >
                {/* ── Cabeçalho ── */}
                ...
                <div style={{ padding: '24px', display: 'flex', flexDirection: 'column', gap: '22px', overflowY: 'visible' }}>
                    ...
                    <div style={{ position: 'relative', zIndex: 50 }}>
                        ...
                        {regraEdicao ? (
                            <input
                                ...
                                style={{ ...inputStyle, background: 'var(--color-surface-sunken)', color: 'var(--color-text-secondary)' }}
                            />
                        ) : (
                    ...
                    {/* ── Escopo da Regra ── */}
                    <div style={{ background: 'var(--color-warning-bg)', padding: '16px', borderRadius: '8px', border: '1px solid rgba(245,158,11,0.15)', position: 'relative', zIndex: 5 }}>
